...
public:
    static std::shared_ptr<Packet> createPacket(MinecraftPacketIds packetId) {
        ...
        if (Address == NULL) {
            Address = SigScan("48 89 5C 24 10 48 89 6C 24 18 48 89 74 24 20 57 48 83 EC 60 48 8B F9 48 89 4C 24 30 33 ED");
        }
...
public:
    ...
    bool isTextPacket() {
        return this->vTable == getVTableFromID(MinecraftPacketIds::Text);
    }
};
